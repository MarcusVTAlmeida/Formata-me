        ...
        <ProgressStep
          ...
          <ProgressStep
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Caso queira importar dados de seu navegador vá na opção "Sim, importar", não há a necessidade de importar agora, Selecione a opção "Agora não" e prossiga.</Text>
            </View>
          </ProgressStep>
          <ProgressStep
            scrollViewProps={this.defaultScrollViewProps}>
