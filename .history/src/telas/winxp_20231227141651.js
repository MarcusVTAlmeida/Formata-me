        ...
        <ProgressSteps>
          ...
          <ProgressStep
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Selecione o formato que deseja formatar a partição, A formatação NTFS é o sistema de arquivos que o Windows gosta de usar por padrão para drives internos executando o sistema operacional ou utilizado como um drive de armazenamento secundário, após a escolha aperte a tecla "ENTER"</Text>
            </View>
          </ProgressStep>
          <ProgressStep
            scrollViewProps={this.defaultScrollViewProps}>
