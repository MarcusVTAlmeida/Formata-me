      ...
      <View style={{ flex: 1 }}>
        <View style={{ alignItems: 'center', justifyContent: "space-around" }}>
          <View style={{ alignItems: 'center', flexDirection: 'column', paddingTop: 15, paddingRight: 15, paddingLeft: 15, width: '100%' }}>
            <TouchableOpacity
              style={{ alignItems: 'center', borderColor: 'black', borderWidth: 5, backgroundColor: '#2F4F4F', paddingRight: 15, paddingLeft: 15, width: '100%' }}
              onPress={() => {
          ...
          <View style={{ alignItems: 'center', flexDirection: 'column', paddingTop: 15, width: '100%' }}>
            <TouchableOpacity
