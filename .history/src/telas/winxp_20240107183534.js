...
style={{ paddingLeft: 20, paddingRight: 20, flex: 1, backgroundColor: '#2F4F4F', position:'relative' }}
class App extends Component {
  render() {
    return (
      <View style={{ paddingLeft: 20, paddingRight: 20, flex: 1, backgroundColor: '#2F4F4F', position:'relative' }}>
        <ScrollView>
        <ProgressSteps>
