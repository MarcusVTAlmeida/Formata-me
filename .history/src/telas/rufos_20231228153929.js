...
class App extends Component {
  render() {
    return (
      <View style={{ paddingLeft: 20, paddingRight: 20flex: 1, backgroundColor: '#2F4F4F' }}>
        <ProgressSteps>
          ...
          <ProgressStep
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Execute o programa. Com o Rufus aberto, verifique se o pen drive que você quer usar já aparece no seletor “Dispositivo”. Caso não, certifique-se de escolher a unidade correta antes de prosseguir.</Text>
            </View>
          </ProgressStep>
          <ProgressStep
            scrollViewProps={this.defaultScrollViewProps}>
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Clique em “Selecionar” e escolha a imagem ISO que deseja usar para criar o seu disco bootável.
              </Text>
            </View>
          </ProgressStep>
          <ProgressStep
