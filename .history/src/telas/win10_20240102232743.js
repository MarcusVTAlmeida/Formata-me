        ...
        <ProgressStep
          ...
          <ProgressStep
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Caso queira importar dados de seu navegador vá na opção "Sim, importar", não há a necessidade de importar agora, Selecione a opção recomendada "Agora não" e prossiga.</Text>
            </View>
          </ProgressStep>
          <ProgressStep
            scrollViewProps={this.defaultScrollViewProps}>
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Selecione a opção "Não" e prossiga.</Text>
            </View>
          </ProgressStep>
          <ProgressStep
            scrollViewProps={this.defaultScrollViewProps}>
          ...
          <ProgressStep
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Selecione a opção "Enviar dados de diagnóstico necessários" e prossiga.</Text>
            </View>
          </ProgressStep>
          <ProgressStep
            scrollViewProps={this.defaultScrollViewProps}>
          ...
          <ProgressStep
            ...
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Selecione a opção "Ignorar" e prossiga.</Text>
            </View>
          </ProgressStep>
          <ProgressStep
            scrollViewProps={this.defaultScrollViewProps}>
            <View style={{ alignItems: 'center' }}>
              ...
              <Text>Selecione a opção "Agora não" e prossiga.</Text>
            </View>
          </ProgressStep>
          <ProgressStep
            scrollViewProps={this.defaultScrollViewProps}>
