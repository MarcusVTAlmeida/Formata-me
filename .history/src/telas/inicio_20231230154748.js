...
class App extends Component {
  render() {
    ...
    <View style={{ flex: 1 }}>
        ...
        <Text style={{ fontSize: 14, color: 'black'}}>Sistemas operacionais</Text>
        <Image style={{ width: 150, height: 150 }}
                source={require('../../img/SO.png')} />
        </View>
        <View style={{ fontWeight: 'bold', alignItems: 'center', flexDirection: 'column' }}>
        <Text style={{ fontSize: 14, color: 'black'}}>Utilitários</Text>
        <Image style={{ width: 150, height: 150 }}
